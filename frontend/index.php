...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Recherche de Palette</h1>
        <!-- Formulaire de recherche -->
        <form action="" method="POST" class="mb-4">
            <div class="row g-3 align-items-center">
                <div class="col-auto">
                    <label for="numPalette" class="col-form-label">Numéro de Palette ou Voyage :</label>
                </div>
                <div class="col-auto">
                    <input type="text" id="search" name="search" class="form-control" placeholder="Ouiii je suis raciiste..."required>
                </div>
                <div class="col-auto">
